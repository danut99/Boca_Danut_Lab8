...
namespace Boca_Danut_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Boca_Danut_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Boca_Danut_Lab8Context context,
